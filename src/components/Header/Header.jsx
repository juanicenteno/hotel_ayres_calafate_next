    ...
    return (
        <>
            <header id="Header" className={`${styles.header} ${showHeader ? styles.visible : styles.hidden}`}>
                ...
                {/* <a className={styles.reserve} href='https://www.todoalojamiento.com/portal/es-es?idHotel=3032' target='_blank' >
                    Reservar Ahora
                </a> */}
                <nav className={pathname === "/gallery" || pathname.startsWith("/rooms") ? styles.desktop_nav2 : styles.desktop_nav}>
                    <div className={styles.divider}>
                        ...
                        <ul className={`${styles.submenu} ${isSubmenuOpen ? 'active' : ''}`}>
                            <Link prefetch={true} href="/rooms/doble-estandar">{t('room_doble_standard')}</Link>
                            <Link prefetch={true} href="/rooms/triple-estandar">{t('room_triple_standard')}</Link>
                            <Link prefetch={true} href="/rooms/suite">{t('suite')}</Link>
                            <Link prefetch={true} href="/rooms/doble-superior">{t('room_doble_superior')}</Link>
                            <Link prefetch={true} href="/rooms/triple-superior">{t('room_triple_superior')}</Link>
                        </ul>
                    </div>
                    ...
                    <section className={styles.container}>
                        ...
                        <ul className={styles.nav_list}>
                            ...
                            <div className={styles.divider}>
                                ...
                                <ul className={`${styles.submenu} ${isSubmenuOpen ? 'active' : ''}`}>
                                    <Link prefetch={true} onClick={handleMobileNavClick} href="/rooms/doble-estandar">{t('room_doble_standard')}</Link>
                                    <Link prefetch={true} onClick={handleMobileNavClick} href="/rooms/triple-estandar">{t('room_triple_standard')}</Link>
                                    <Link prefetch={true} onClick={handleMobileNavClick} href="/rooms/suite">{t('suite')}</Link>
                                    <Link prefetch={true} onClick={handleMobileNavClick} href="/rooms/doble-superior">{t('room_doble_superior')}</Link>
                                    <Link prefetch={true} onClick={handleMobileNavClick} href="/rooms/triple-superior">{t('room_triple_superior')}</Link>
                                </ul>
                            </div>
                            <a onClick={handleMobileNavClick} className={styles.list_item} href="#faq2">{t('faq')}</a>
                            <Link prefetch={true} onClick={handleMobileNavClick} className={styles.list_item} href="/contact">{t('contact')}</Link>
                            <div className={styles.socials_container}>
                                <a className={styles.social_item} href="">
