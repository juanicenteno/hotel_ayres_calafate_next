...
export const metadata = {
  ...
  twitter: {
    ...
    images: ["https://ayresdecalafate.com/images/ayresnegro2.webp"],
  },
  ...
  return (
    <html lang={locale || "es"} className={`${ebGaramond.variable} ${lora.variable} ${bodar.variable}`} data-scroll-behavior="smooth">
      <body id="Body">
        ...
        <a aria-label="abrir chat de whatsapp" className={styles.wpp_btn} href='https://wa.me/5492966568253?text=Ayres%20de%20Calafate%20-%20Hotel%20Boutique%0A%F0%9F%91%8B%20%21Hola%21%20Quisiera%20reservar%20para%20%2A%5Bfecha%5D%2A%20para%20%2A%5Bcantidad%20de%20personas%5D%2A.%20%C2%BFPodr%C3%ADas%20confirmarme%20la%20disponibilidad%3F%20%F0%9F%98%8A' target='_blank'>
