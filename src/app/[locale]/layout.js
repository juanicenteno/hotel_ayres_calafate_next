  ...
  return (
    <html lang={locale || "es"} className={`${ebGaramond.variable} ${lora.variable} ${bodar.variable}`} data-scroll-behavior="smooth">
      <body id="Body">
        ...
        <a aria-label="abrir chat de whatsapp" className={styles.wpp_btn} href='https://wa.me/5492902405455' target='_blank'>
